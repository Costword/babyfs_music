  ...
  void initState() {
    ...
    _barItems = [
      BottomNavigationBarItem(
          label: "发现",
          icon: Icon(PersonalIcons.discover,
              size: 24, color: MusicStroe.Theme(context).IconColor),
          activeIcon: Icon(PersonalIcons.discover,
              size: 24, color: MusicStroe.Theme(context).IconSelectColor),
          backgroundColor: MusicStroe.Theme(context).theme),
      BottomNavigationBarItem(
          label: "设置",
          icon: Icon(PersonalIcons.wode,
              size: 24, color: MusicStroe.Theme(context).IconColor),
          activeIcon: Icon(PersonalIcons.wode,
              size: 24, color: MusicStroe.Theme(context).IconSelectColor),
          backgroundColor: MusicStroe.Theme(context).theme),
    ];
    super.initState();
