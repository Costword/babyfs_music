...
//计算需要滚动的位置
double _getTargetPixel(ScrollPosition position,Tolerance tolerance,double velocity,double leading) {
...
@override
  Simulation createBallisticSimulation(ScrollMetrics position, double velocity) {
    ...
    final double target = _getTargetPixel(position, tolerance, velocity, mypaddingSpacing);
